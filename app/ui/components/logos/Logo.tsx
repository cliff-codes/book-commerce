  ...
  return (
    <Link href={'/'}>
        ...
        <g id="Group_4" data-name="Group 4" transform="translate(-310.247 -16)">
            <text id="B" transform="matrix(0.978, 0.208, -0.208, 0.978, 312.742, 52.191)" fill="#ff7438" fontSize="35" fontFamily="Poppins-Bold, Poppins" fontWeight="700"><tspan x="0" y="0">B</tspan></text>
            ...
            <text id="docs" transform="translate(5.116 17.851)" fill="#fff" fontSize="17" fontFamily="Poppins-Regular, Poppins"><tspan x="0" y="0">docs</tspan></text>
            </g>
        </g>
        </svg>
    </Link>
